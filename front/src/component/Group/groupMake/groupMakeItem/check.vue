<template>
    <div style="width:100%;">
        <h1>그룹 생성 정보 확인</h1>
        <p>
            현재까지 작성하신 정보입니다. '생성 완료' 버튼을 누르시면 그룹이 만들어집니다.
        </p>
        <div class="box">
        ...
        <div v-if="!this.$parent.open" class="box">
            ...
            <div @mouseover="seePassword('pw')" @mouseleave="hidePassword('pw')" class="addContainer addBtn active">마우스 올려 확인하기</div>
        </div>
        <div class="box">
            <div class="title">그룹 관리 비밀번호</div>
            <hr style="width: 20%;">
            <input disabled="disabled" type="password" id="aPw" :value="this.$parent.adminPassword">
            <div @mouseover="seePassword('aPw')" @mouseleave="hidePassword('aPw')" class="addContainer addBtn active">마우스 올려 확인하기</div>
        </div>
        <div class="addBox">
            <div @click="back(2)" class="addContainerBottom addBtn active">이전</div>
            <div @click="valiOnBtn" class="addContainerBottom addBtn active">생성 완료</div>
        </div>
    </div>
</template>
